...
<head>
    ...
    <title>Helping Hands - Organización benéfica</title>
            ...
            <div class="dirrecion">
                    ...
                    <div class="mb-3 mt-3">
                        <form id="formStreet" name="formStreet" class="d-flex">
                           <div class="op">
                                <label>Calle:</label>
                                <input name="street" id="street" data-validetta="street"  class="w-75"value='Nuevo Leon 41' disabled />
                           </div>
                            <div class="botones">
                    ...
                    <div class="mb-3 mt-3">
                        <form id="formZipCode" name="forZip" class="d-flex">
                           <div class="op">
                                ...
                                <input name="ZipCode" id="zipCode"  data-validetta="zip" value='09518' disabled />
                           </div>
                           <div class="botones">
