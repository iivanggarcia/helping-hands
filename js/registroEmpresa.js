$(document).ready(function(){
    $("form#formRegistroEmpresa").validetta({
        bubblePosition:"bottom",
        bubbleGapTop: 10,
        bubbleGapLeft: -5,
        onValid:function(e){
            e.preventDefault();
            var formData = new FormData($("form#formRegistroEmpresa")[0]); //con jquery tengo acceso al elemento pero accedo al primer índice para realmente tener acceso a él
            $.ajax({
                url:"registroEmpresa_AX.php",
                method:"post",
